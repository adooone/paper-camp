...
| FEAT-31 | Claude Code native integration | review | integration, claude-code, skill, hooks, cli |
| FEAT-32 | Paper Camp MCP server | in-progress | mcp, server, core, integration |
