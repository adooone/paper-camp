...
### Phases
- [ ] Add startRunAllPhases loop to agent.ts
...
- [ ] Add per-phase verification gate
...
- [ ] Wire commitPhase callback from api.ts
...
- [ ] Enforce stop-on-failure and end-of-run status
