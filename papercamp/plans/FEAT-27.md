...
### Phases
- [ ] Add branch-hygiene helpers to git.ts
...
- [ ] Extend the plan-start gate in api.ts
...
- [ ] Add "Sync to main" button to stack-panel.tsx
...
- [ ] Wire hygiene status into the dashboard header or plan-start flow
