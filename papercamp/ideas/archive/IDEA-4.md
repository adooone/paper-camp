...
### Notes
- [x] [body] [decision] Confirm Claude Code's headless stream-json shape before writing the adapter
- [x] [body] [decision] Verify opencode's CLI before assuming it generalizes from Claude Code
