...
The phase convergence audit: an append-only agent pass comparing a plan's intent against the code and appending clearly-missing phases, never rewriting existing ones.
