...
GitHub CI/CD: workflows running tsc/biome/vitest on PRs, commitlint enforcement, automated npm publish, and branch protection, acting as the Scout app.
