...
Built the Docs page: a /docs route rendering repo docs, decisions, open questions, and progress from the already-built API, with cross-links between questions and their resolving decisions.
