...
The Stack panel's Commit section: the live working-tree diff plus a small form to stage and commit without a terminal — deliberately no push button at first.
