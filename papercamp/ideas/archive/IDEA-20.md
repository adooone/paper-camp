...
The per-file storage migration: one YAML-frontmatter file per plan/idea replacing the monolithic plans.md/ideas.md, with generated indexes and the archive/ move.
